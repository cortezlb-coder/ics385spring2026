...
QR CODE PROJECT
- TO START: RUN index.js and follow instruction 
- Prompts user to enter a URL using the inquirer npm package
- Generates a QR code image using the qr-image npm package
- Saves the user-entered URL to a text file using the fs module
- Added input validation to ensure the URL is not empty and properly formatted
